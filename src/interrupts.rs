...
use crate::{
    gdt,
    interrupts::InterruptIndex::{Keyboard, Timer},
    print, println,
};
...
lazy_static! {
    static ref IDT: InterruptDescriptorTable = {
        ...
        unsafe {
            idt.double_fault
                .set_handler_fn(double_faults_handler)
...
extern "x86-interrupt" fn double_faults_handler(
...
fn notify_pic(interrupt_index: InterruptIndex) {
    unsafe {
